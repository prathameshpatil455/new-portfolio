...
const Experience = () => {
  ...
  const categories = [
    { name: "Frontend", logoLight: frontEndLightIcon, logoDark: frontEndDarkIcon },
    { name: "Backend", logoLight: "/images/backend-light.png", logoDark: "/images/backend-dark.png" },
    { name: "Machine Learning", logoLight: "/images/ml-light.png", logoDark: "/images/ml-dark.png" },
    { name: "Version Control", logoLight: "/images/version-control-light.png", logoDark: "/images/version-control-dark.png" },
  ];
    ...
    <div className="bg-white dark:bg-gray-800 w-full h-screen pt-32 max-sm:pt-72">
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col h-full text-black dark:text-white">
        <div>
          ...
          <p className="py-6">Select a category to view the technologies I've worked with.</p>
        </div>
              ...
              {categories.map(({ name, logoLight, logoDark }) => (
                <li
                  ...
                  className={`cursor-pointer p-2 rounded-md flex items-center hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-300 ${
                    selectedCategory === name ? "bg-gray-200 dark:bg-gray-700" : ""
                  }`}
